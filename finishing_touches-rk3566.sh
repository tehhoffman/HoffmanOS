...
# Mark completed HoffmanOS updates with this current build
...
do
 ...
 wget -t 3 -T 60 --no-check-certificate https://github.com/PortsMaster/PortMaster-GUI/releases/download/2026.01.19-0955/Install.PortMaster.sh
 if [ $? == 0 ]; then
  break
 fi
 sleep 10
